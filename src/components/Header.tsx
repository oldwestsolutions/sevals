...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 lg:left-64 h-14 sm:h-16 bg-[#0f0f0f] border-b border-gray-800 z-50">
          ...
          <div className="flex items-center">
            <div className="flex-1 relative">
              <input
                type="text"
                placeholder="Search"
                className="w-full bg-[#121212] text-white px-3 lg:px-4 py-2 rounded-l-full border border-gray-700 focus:outline-none focus:border-blue-500 text-sm lg:text-base"
              />
              <button className="absolute right-0 top-0 h-full px-4 lg:px-6 bg-[#272727] rounded-r-full border border-l-0 border-gray-700 hover:bg-[#3f3f3f] transition-colors">
                <MagnifyingGlassIcon className="h-4 w-4 lg:h-5 lg:w-5 text-gray-400" />
              </button>
            </div>
            <button className="ml-2 lg:ml-4 p-2 bg-[#272727] rounded-full hover:bg-[#3f3f3f] transition-colors">
              <MicrophoneIcon className="h-4 w-4 lg:h-5 lg:w-5 text-gray-400" />
            </button>
          </div>
        </div>
